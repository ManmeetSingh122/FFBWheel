 ...
 *    after ~4 seconds. Motor goes to 0 on reset because TIM1 restarts at 0.
 *    Timeout is 4s (not shorter) to safely cover the flash sector erase
 *    in Config_Save() which can block for up to ~2s.
 *
